...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\GroupTagController' => 'getGroupTagControllerService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/HttpCache/EventListener/AddTagsListener.php';
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'api_platform.doctrine.listener.http_cache.purge' => ['privates', 'api_platform.doctrine.listener.http_cache.purge', 'getApiPlatform_Doctrine_Listener_HttpCache_PurgeService', true],
        ...
        $d->addEventListener([0 => 'preUpdate'], 'api_platform.doctrine.listener.http_cache.purge');
        $d->addEventListener([0 => 'onFlush'], 'api_platform.doctrine.listener.http_cache.purge');
        $d->addEventListener([0 => 'postFlush'], 'api_platform.doctrine.listener.http_cache.purge');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\GroupTagRepository' => ['privates', 'App\\Repository\\GroupTagRepository', 'getGroupTagRepositoryService', true],
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.response', [0 => function () {
            return ($this->privates['api_platform.http_cache.listener.response.add_tags'] ?? $this->getApiPlatform_HttpCache_Listener_Response_AddTagsService());
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bK45CExVGr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('axSd9DQyHW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I3lhCs3-PQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CbjTz+88pO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dGY3827Ikq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_admin_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => ['privates', 'annotated_app_entity_admin_api_platform_core_bridge_doctrine_orm_filter_boolean_filter', 'getAnnotatedAppEntityAdminApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService', true],
            'annotated_app_entity_apprenant_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => ['privates', 'annotated_app_entity_apprenant_api_platform_core_bridge_doctrine_orm_filter_boolean_filter', 'getAnnotatedAppEntityApprenantApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService', true],
            'annotated_app_entity_formateur_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => ['privates', 'annotated_app_entity_formateur_api_platform_core_bridge_doctrine_orm_filter_boolean_filter', 'getAnnotatedAppEntityFormateurApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService', true],
            ...
            'annotated_app_entity_admin_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => '?',
            'annotated_app_entity_apprenant_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => '?',
            'annotated_app_entity_formateur_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' => '?',
    ...
    /**
     * Gets the private 'api_platform.http_cache.listener.response.add_tags' shared service.
     *
    ...
    {
        return $this->privates['api_platform.http_cache.listener.response.add_tags'] = new \ApiPlatform\Core\HttpCache\EventListener\AddTagsListener(($this->privates['api_platform.iri_converter'] ?? $this->getApiPlatform_IriConverterService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('av0hRR6l0q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('y+VAkRQnxE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['debug.security.voter.App\\Security\\Voter\\CompetencesVoter'] ?? $this->load('getCompetencesVoterService'));
            ...
            yield 5 => ($this->privates['debug.security.voter.App\\Security\\Voter\\GroupeVoter'] ?? $this->load('getGroupeVoterService'));
            yield 6 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ProfilSortieVoter'] ?? $this->load('getProfilSortieVoterService'));
    ...
    protected function getDebug_Security_FirewallService()
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.reset_pwd' => ['privates', 'security.firewall.map.context.reset_pwd', 'getSecurity_Firewall_Map_Context_ResetPwdService', true],
        ], [
            'security.firewall.map.context.api' => '?',
            'security.firewall.map.context.dev' => '?',
            'security.firewall.map.context.login' => '?',
            'security.firewall.map.context.reset_pwd' => '?',
        ]), new RewindableGenerator(function () {
            yield 'security.firewall.map.context.dev' => ($this->privates['.security.request_matcher.Iy.T22O'] ?? ($this->privates['.security.request_matcher.Iy.T22O'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/')));
            yield 'security.firewall.map.context.reset_pwd' => ($this->privates['.security.request_matcher.WcrVauQ'] ?? ($this->privates['.security.request_matcher.WcrVauQ'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/reset_password')));
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.anonymous.reset_pwd'] ?? ($this->privates['security.authentication.provider.anonymous.reset_pwd'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
