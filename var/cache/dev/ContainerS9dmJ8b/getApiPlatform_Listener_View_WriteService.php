...
class getApiPlatform_Listener_View_WriteService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.listener.view.write'] = new \ApiPlatform\Core\EventListener\WriteListener(new \ApiPlatform\Core\Bridge\Symfony\Bundle\DataPersister\TraceableChainDataPersister(new \ApiPlatform\Core\DataPersister\ChainDataPersister(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\DataPersister\\ApprenantPersister'] ?? $container->load('getApprenantPersisterService'));
            yield 1 => ($container->privates['App\\DataPersister\\CompetencePersister'] ?? $container->load('getCompetencePersisterService'));
            yield 2 => ($container->privates['App\\DataPersister\\FormateurPersister'] ?? $container->load('getFormateurPersisterService'));
            yield 3 => ($container->privates['App\\DataPersister\\ProfilSortiePersister'] ?? $container->load('getProfilSortiePersisterService'));
            yield 4 => ($container->privates['App\\DataPersister\\ProfileDataPersister'] ?? $container->load('getProfileDataPersisterService'));
            yield 5 => ($container->privates['App\\DataPersister\\ReferentielPersister'] ?? $container->load('getReferentielPersisterService'));
            yield 6 => ($container->privates['api_platform.doctrine.orm.data_persister'] ?? $container->load('getApiPlatform_Doctrine_Orm_DataPersisterService'));
        }, 7))), ($container->privates['api_platform.iri_converter'] ?? $container->getApiPlatform_IriConverterService()), ($container->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? $container->getApiPlatform_Metadata_Resource_MetadataFactory_CachedService()), ($container->privates['api_platform.resource_class_resolver'] ?? $container->getApiPlatform_ResourceClassResolverService()));
    }
}
