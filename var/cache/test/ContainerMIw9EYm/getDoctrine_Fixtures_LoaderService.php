...
class getDoctrine_Fixtures_LoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addFixtures([0 => ['fixture' => ($container->privates['App\\DataFixtures\\AdminFixtures'] ?? $container->load('getAdminFixturesService')), 'groups' => []], 1 => ['fixture' => ($container->privates['App\\DataFixtures\\AppFixtures'] ?? ($container->privates['App\\DataFixtures\\AppFixtures'] = new \App\DataFixtures\AppFixtures())), 'groups' => []], 2 => ['fixture' => ($container->privates['App\\DataFixtures\\ApprenantFixtures'] ?? $container->load('getApprenantFixturesService')), 'groups' => []], 3 => ['fixture' => ($container->privates['App\\DataFixtures\\FormateurFixtures'] ?? $container->load('getFormateurFixturesService')), 'groups' => []], 4 => ['fixture' => ($container->privates['App\\DataFixtures\\ProfileFixtures'] ?? ($container->privates['App\\DataFixtures\\ProfileFixtures'] = new \App\DataFixtures\ProfileFixtures())), 'groups' => []]]);
