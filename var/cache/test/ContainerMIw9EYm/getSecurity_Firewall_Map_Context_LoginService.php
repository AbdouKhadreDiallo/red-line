...
class getSecurity_Firewall_Map_Context_LoginService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 5), ($container->privates['security.exception_listener.login'] ?? $container->load('getSecurity_ExceptionListener_LoginService')), NULL, ($container->privates['security.firewall.map.config.login'] ?? $container->load('getSecurity_Firewall_Map_Config_LoginService')));
    }
}
